...
public class LeetCode121 {
     ...
     *
     * На каждом проходе мы сравниваем текущий элемент с текущим минимальным значением, если текущий элемент меньше, значит, мы потеряли деньги,
     * просто меняем текущий минимальный элемент.
